...
YADrone is yet another open framework for controlling the AR.Drone 2. 
Heavily modified and refactored. New threading model using java.util.concurrent - unified. 
Added raw data listener and other enhanced listeners
Fixed a few bugs.
